    ...
    <div class="row">        
        <div class="col-md-4">
            <div class="panel panel-default" id="form">
                <div class="panel-heading"><span>Buat</span> Kabupaten</div>
                <div class="panel-body">
                    <form id="form-simpan" action="{{route('kategori.store')}}" method="POST" class="simpan" enctype="multipart/form-data">
                        <div class="form-group">
                            <label>Nama Kabupaten</label>
                            <input type="text" id="nama" name="nama" class="form-control" placeholder="Masukan Nama Kabupaten" required>
                        </div>                        
                        <div class="form-group">
        ...
        <div class="col-md-8">
            <div class="panel panel-default">
                <div class="panel-heading">Kabupaten</div>
...
<div class="alert alert-warning alert-dismissible" role="alert" id="successAlert">
  ...
  <strong>Sukses</strong> <span id="message">Simpan Kabupaten</span>
</div>
<!-- Modal -->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        Anda Yakin Menghapus Kabupaten?
      </div>
...
<script src="{{ asset('public/js/kabupaten.js') }}"></script>
@endsection
