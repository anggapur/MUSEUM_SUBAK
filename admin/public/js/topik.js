	...
	$.ajax({
        ...
        success: function (data) {
            ...
            $.each(datas, function(index) {
            	...
            	"<i title='Turun' onclick='reOrderDown("+datas[index].id+")' class='fa fa-chevron-down' aria-hidden='true' data='"+datas[index].id+"'></i>"+
            	"<i title='Naik' onclick='reOrderUp("+datas[index].id+")' class='fa fa-chevron-up' aria-hidden='true' data='"+datas[index].id+"'></i>"+            	
	            ...
	            $('.bodyData').append(apen);	
	             $.each(datas[index].get_childs, function(i) {
	             	...
	             	"<i title='Turun' onclick='reOrderDown("+datas[index].get_childs[i].id+")' class='fa fa-chevron-down' aria-hidden='true' data-parent='"+datas[index].id+"' data='"+datas[index].get_childs[i].id+"'></i>"+
	             	"<i title='Naik' onclick='reOrderUp("+datas[index].get_childs[i].id+")' class='fa fa fa-chevron-up' aria-hidden='true' data-parent='"+datas[index].id+"' data='"+datas[index].get_childs[i].id+"'></i>"+
